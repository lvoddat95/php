...
'use strict';
		...
		$.extend(RotateImage.prototype, {
		    ...
		    init: function () {
		        ...
		        self.$button_left = $('<button data-rotate-left class="fancybox-button fancybox-button--rotate" title="Xoay sang trái"><i class="fas fa-undo" aria-hidden="true"></i></button>')
		            .prependTo(this.instance.$refs.toolbar)
		            .on('click', function (e) {
		                self.rotate('left');
		            });

		        self.$button_right = $('<button data-rotate-right class="fancybox-button fancybox-button--rotate" title="Xoay sang phải"><i class="fas fa-redo" aria-hidden="true"></i></button>')
		            .prependTo(this.instance.$refs.toolbar)
		            .on('click', function (e) {
		                self.rotate('right');
		            });
